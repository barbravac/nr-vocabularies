...
copy_spec ui_components_specs \
          ...
          nr_vocabularies_model_builder

# copy versions
cp nr-vocabularies/nr_vocabularies/version.py \
   nr-vocabularies-model-builder/nr_vocabularies_model_builder/
cp nr-vocabularies/nr_vocabularies/version.py \
   nr-vocabularies-ui/nr_vocabularies_ui/

test -d dist && rm -rf dist

mkdir dist

for distro in nr-vocabularies nr-vocabularies-model-builder nr-vocabularies-ui ; do
  (
